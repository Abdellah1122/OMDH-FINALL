          ...
          <div className="container">
            <div className="content-body">
                ...
                <div className="highlight-box">
                    <h3>"أي فعلية لحقوق الإنسان في ظل التحولات الدولية الراهنة؟"</h3>
                </div>
                ...
                <div className="highlight-box">
                    ...
                    <ul>
                        ...
                        <li>إنشاء هيكل تنظيمي جديد يسمى "لجنة كتاب الجهات والفروع" تجتمع ثلاث مرات في السنة، وكلما اقتضت الضرورة ذلك</li>
