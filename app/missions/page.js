        ...
        <section className="hero-section">
          <div className="hero-content">
            ...
            <div className="hero-description">
              <h2>الحقوق السياسية والمدنية والاقتصادية والاجتماعية والثقافية والبيئية والإيكولوجية والحق في التنمية، منظومة كلية لا تقبل التجزئة</h2>
              ...
              <Link href="/about-us" className="btn-secondary">اكتشف مسار فعلنا</Link>
            </div>
          </div>
        ...
        <div className="main-content">
          ...
          <section className="missions-section">
            <div className="missions-grid">
              ...
              <div className="mission-card">
                ...
                <p>رصد جميع انتهاكات حقوق الإنسان وكشفها والإبلاغ عنها وومتابعة معالجتها بشكل فعال، من خلال إصدار البيانات الصحفية والتقارير الموازية، ولجن البحث والتقصي.</p>
              </div>
              ...
              <div className="mission-card">
                ...
                <h4>  الانخراط في المنظومة الدولية</h4>
          ...
          <section className="timeline-section">
            <div className="timeline-header">
              ...
              {/* FIX: Replaced l' with l&apos; */}
              <p>يغطي عملنا العديد من المجالات الحيوية، مع التركيز على الترافع، والدعم القانوني، والتعليم، والتعاون الدولي لدعم معايير حقوق الإنسان.</p>
            </div>
            ...
            <div className="timeline">
              <div className="timeline-item">
                ...
                <div className="timeline-content">
                  ...
                  {/* FIX: Replaced d' with d&apos; */}
                  <p className="timeline-description">نشر البيانات والدوريات والتقارير المواضيعية (على سبيل المثال، تقارير حول الانتخابات، وضعية السجون، التقرير الدوري عن حالة حقوق الانسان بالمغرب..  ) وغيرها من الوثائق المتعلقة بقضايا ومواقف حقوق الإنسان.</p>
                </div>
              </div>
              ...
              <div className="timeline-item">
                ...
                <div className="timeline-content">
                  ...
                  <p className="timeline-description">
                    نرافع وندعو القادة السياسيين والكتل البرلمانية إلى ضمان احترام حقوق الإنسان وتعزيز الإصلاحات التشريعية.
                   </p>
                </div>
              </div>
              ...
              <div className="timeline-item">
                ...
                <div className="timeline-content">
                  ...
                  <p className="timeline-description">تنظيم الندوات والمؤتمرات والمعارض الفنية وغيرها من الفعاليات لرفع مستوى الوعي ومناقشة قضايا حقوق الإنسان.</p>
                </div>
              </div>
            </div>
          </section>
