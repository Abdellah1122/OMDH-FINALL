      ...
      <nav className={`navbar ${isScrolled ? "scrolled" : ""}`}>
        ...
        <div className="nav-buttons">
          ...
          <div className="dropdown-wrapper">
            ...
            >
              ...
              <svg
                ...
                viewBox="0 0 12 12"
                fill="none"
                style={{color: 'black',backgroundColor:'transparent',border:'none', textDecoration: 'none'}}
              >
          ...
          {mainNavItems.map((item) => (
            <Link key={item.href} href={item.href} className="nav-btn" style={{color: 'black',backgroundColor:'transparent',border:'none', textDecoration: 'none'}}>
