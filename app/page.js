...
const newsItems = [
  {
    date: "",
    title: "لقاء تواصلي مع قيادة حزب الاصالة والمعاصرة",
...
{
    date: "",
    title: "وسيط المملكة يستقبل وفد عن المكتب التفيذي للمنظمة.",
  ...
  {
    date: "",
    title: "لقاء تواصلي بين المكتب التنفيذي للمنظمة والهيئة الوطنية للنزاهة والوقاية من الرشوة ومحاربتها.",
  ...
  {
    date: "",
    title: "لقاء مع السيد عيسى رحمون، والسيدة نصيرة داتور",
  ...
  {
    date: "",
    title: "لقاء تواصلي مع الأمين العام لحزب التقدم والاشتراكية",
  ...
  {
    date: "",
    title: "الكاتب الأول لحزب الاتحاد الاشتراكي يستقبل وفدا عن المنظمة ",
...
const timelineEvents = [
  ...
  {
    "year": "بداية 1989",
    "title": "الدعوة إلى إطلاق سراح كافة المعتقلين السياسيين وعودة المنفيين",
    "description": "أطلقت المنظمة المغربية لحقوق الإنسان دعوات للعفو عن المعتقلين في القضايا السياسية، والسماح بعودة المغتربين مع تمتيع المعنيين بالأمر بكامل حقوقهم، ودعت إلى مراجعة قوانين وضعية السجون والسجناء وتحسين أوضاعها",
    "image": "/Images/prison_kenitra.jpg",
    "type": "secondary"
  },
  {
    "year": "بداية التسعينات",
    "title": "الدعوة إلى توسيع مجال ممارسة الحريات",
    "description": "  المطالبة بتطبيق نزيه للقانون في علاقة الحاكمين بالمحكومين، وبالعدول عن التراجعات التشريعية التي ضيقت من مجال ممارسة الحريات، بالسماح للتعددية الفكرية والسياسية أن تتبلور بكل حرية وبدون تضييق ولا تحريف، برفع كل تضييق على التعبير والرأي والنشر والإيداع.  ",
    "image": "/Images/freedomeofspech1.jpg",
    "type": "secondary"
  },
   {
    "year": " 2003",
    "title": "التنديد بنظام الهيمنة الدولية التي تحاول الولايات المتحدة الأمريكية فرضه على العالم",
    "description": "  نددت المنظمة بنظام الهيمنة الدولية التي تحاول الولايات المتحدة الأمريكية فرضه على العالم لإقامة سياسة متعارضة كليا مع كل المكتسبات والقواعد المنظمة للشرعية الدولية، ومنظومة القانون الدولي لحقوق الإنسان التي أقرتها البشرية بعد عقود طويلة من الكفاح الدؤوب ضد الظلم والاستبداد والاستعباد والقهر، ودعت إلى ضرورة إلى الالتزام بمنظومة القانون الدولي لحقوق الإنسان خاصة القانون الدولي الإنساني باعتبارها سبيلا للحد من استمرار العدوان ومنطق الاستعمار الجديد.",
    "image": "/Images/usa1.jpg",
    "type": "secondary"
  },
  {
    "year": " 2003",
    "title": "الدعوة إلى وضع استراتيجية شاملة ومندمجة في مجال حقوق الإنسان والسياسات العمومية والخاصة المرتبطة بها",
    "description": "  طالبت المنظمة بضرورة التأصيل الدستوري للحريات والحقوق، من حيث فصل السلطة، وتعزيز السلطة القضائية، واستكمال التسوية العادلة والمنصفة لماضي الانتهاكات الجسيمة على قاعدة حوار جدي ومسؤول مع هيئة المتابعة، إعمالا لتوصيات المناظرة الوطنية حول ملف الانتهاكات الجسيمة لحقوق الانسان، ومطالبها العادلة، فيما يخص الكشف عن مجهولي المصير، والاعتذار، وإحداث الهيئة المستقلة للحقيقة، وباقي المطالب العادلة للضحايا والمجتمع.",
    "image": "/Images/cndh.jpg",
    "type": "secondary"
  },
  {
    "year": " 2006",
    "title": "     الدعوة إلى تعميق وتسريع وتيرة الاصلاحات وحماية الانتقال الديمقراطي",
     "description": " اعتبرت المنظمة أن مرحلة الانتقال الديمقراطي بقدر ما تفتح إمكانات غير مسبوقة في مجال حقوق الإنسان ثقافة وممارسة، فهي مرشحة للانتكاس والتراجع في أية لحظة مما يتطلب ضرورة تحقيق الاصلاحات وتسريع وتيرتها لبناء دولة الحق،وأن تعميق وتسريع الإصلاحات يقتضي مراجعة الدستور بما يضمن الحريات والحقوق ويعزز اضطلاع المؤسسات بدورها في البناء الديمقراطي بما يتطلبه من فصل للسلط وتعزيز لاستقلال القضاء.  ",
    "image": "/Images/الدستور-المغربي.jpg",
    "type": "secondary"
  },
  ...
  {
    "year": "2011",
    "title": "دينامية 20 فبراير والإصلاح الدستوري",
    "description": "   ثمنت المنظمة الحراك السياسي والمجتمعي الذي انطلق مع مظاهرات 20 فبراير، واعتبرتها قيمة مضافة لنضالات، الشعب المغربي منذ عقود من أجل الديمقراطية وحقوق الإنسان ومحاربة الفساد، وتعبيرا عن تنامي حركية المجتمع المغربي بانخراط أجيال جديدة في مسار هذا النضال، وسجلت بارتياح التفاعل الفوري مع هذه الحركية بإقرار إصلاح دستوري ما فتئت المنظمة تطالب به وتقدم مقترحات بشأنه.",
    "image": "/Images/20-FEVR.jpg",
    "type": "primary"
  },
  {
    "year": "أبريل 2025",
    "title": "التضامن مع الشعب الفلسطيني",
    "description": "خلال مؤتمرها الوطني الثاني عشر، أعربت المنظمة المغربية لحقوق الإنسان عن تضامنها مع الشعب الفلسطيني وأدانت العدوان الإسرائيلي المستمر على غزة، ودعت إلى تدخل وضع حد للانتهاكات الحقوقية الجسيمة والممنهجة ولجرائم الإبادة الجماعية التي يتعرض لها المدنيون بفلسطين لمحتلة،وطالب المجتمع الدولي بتحمل مسؤوليته الكاملة في حماية المدنيين العزل ووقف حرب الإبادة الجماعية التي يتعرض لها لشعب الفلسطيني.",
          ...
          <div className="values-section">
              ...
              <div className="values-container">
                <div className="value-card">
                  ...
                  <h3>عدالة</h3>
                  <p>نسعى إلى تحقيق العدالة من خلال الدعوة إلى إصلاح المنظزمة القانونية الوطنية،والمساءلة والدفاع عن الحقوق الفردية والجماعية، وضمان العدالة والمساواة لجميع مكوانات المجتمع المغربي.</p>
                </div>
                <div className="value-card">
                  <div className="value-icon"><div className="icon-circle"><span>🕊️</span></div></div>
                  <h3>كرامة</h3>
                ...
                <div className="value-card">
                  ...
                  <h3>تكافل</h3>
                  <p>نحن نتعاون مع كل مكونات المجتمع والهيئات السياسية والمنظمات المدنية والسلطات العمومية لبناء صوت جماعي لحقوق الإنسان وتعزيز مشاركة المجتمع المدني.</p>
                </div>
                <div className="value-card">
                  <div className="value-icon"><div className="icon-circle"><span>📣</span></div></div>
                  <h3>المرافعة</h3>
                  <p>نحن نشارك بشكل فعال في النقاش العمومي، ونسعى للتاثير على السياسات، ونتخذ إجراءات ملموسة لحماية حقوق الإنسان والحريات الديمقراطية.</p>
                </div>
              </div>
            </div>
          {/* Map Section */}
